  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved deployment as @deployment" do
        post :create, {:deployment => invalid_attributes}, valid_session
        expect(assigns(:deployment)).to be_a_new(Deployment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested deployment" do
        deployment = Deployment.create! valid_attributes
        put :update, {:id => deployment.to_param, :deployment => new_attributes}, valid_session
        deployment.reload
      ...
      it "redirects to the deployment" do
        deployment = Deployment.create! valid_attributes
        put :update, {:id => deployment.to_param, :deployment => valid_attributes}, valid_session
        expect(response).to redirect_to(deployment)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the deployment as @deployment" do
        deployment = Deployment.create! valid_attributes
        put :update, {:id => deployment.to_param, :deployment => invalid_attributes}, valid_session
        expect(assigns(:deployment)).to eq(deployment)
      end
